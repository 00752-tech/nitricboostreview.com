...
import { ArrowLeft, ArrowRight, Facebook, Twitter, LinkedinIcon as LinkedIn } from 'lucide-react'
...
export default function BlogPostTemplate({ title, date, content, citations, featuredImage, author, authorBio, metadata, relatedArticles }: BlogPostProps) {
  useEffect(() => {
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {relatedArticles.map((article, index) => (
              <Link key={index} href={`/blog/${article.id}`} className="block p-4 bg-secondary rounded-lg hover:bg-secondary/70 transition-colors">
